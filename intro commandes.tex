...
tube, redirection de flux, regexp simple, logiciel sympa (tmux, mocp, lua/bash/python), make/gcc, du, df, touch, find/locate, chmod, chown, kill, nano, tar, wget,

\section{Regexp (expert)}
regexp compliqué, un peu de réseaux? services, mount, ncdu, halt/reboot, find, ps, awk, sed, ssh, git?, usermod/groupmod, ifconfig
