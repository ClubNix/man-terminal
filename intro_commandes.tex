...
Dans le monde réel, \emph{bash} est l'interpréteur le plus courant, cependant pour quelques raisons obscures, vous commencerez par défaut votre aventure à l'ESIEE avec \emph{tcsh}.
